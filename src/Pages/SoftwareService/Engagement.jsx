        ...
        <div className="bg-[#FAFAFA] mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 text-center px-24 gap-8 py-16">
                ...
                <div data-aos="fade-up"
                   data-aos-anchor-placement="top-bottom" className=" border p-6 bg-white">
                ...
                <div data-aos="fade-up"
                   data-aos-anchor-placement="center-bottom" className=" border p-6 bg-white">
                ...
                <div data-aos="fade-up"
     data-aos-anchor-placement="bottom-bottom" className=" border p-6 bg-white">
                ...
                <div data-aos="fade-up"
     data-aos-anchor-placement="top-center" className=" border p-6 bg-white">
                ...
                <div data-aos="fade-up"
     data-aos-anchor-placement="center-center" className=" border p-6 bg-white">
        ...
        <div className='bg-black lg:px-6 lg:py-3 md:w-44 w-72 p-2 lg:w-72  mx-auto md:mx-auto   rounded gap-4 text-white flex  flex-row items-center justify-center '>
